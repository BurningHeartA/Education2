                ...
                while (j < le and NextB):
                    ...
                    if Gears[j][0] >= B_MinMax[0] and Gears[j][1] > 0:
                        ...
                        if Gears[j][0] <= B_MinMax[1]:
                            ...
                            Comparisons += 1
                            if C_MinMax[0] <= C_MinMax[1] and C_MinMax[0] <= Gears[le-1][0] and C_MinMax[1] >= Gears[0][0]:
                                k = 0
                                NextC = True
                                while (k < le and NextC):
                                    ...
                                    if Gears[k][0] >= C_MinMax[0] and Gears[k][1] > 0:
                                        ...
                                        if Gears[k][0] <= C_MinMax[1]:
                                            ...
                                            Comparisons += 1
                                            if D_MinMax[0] <= D_MinMax[1] and D_MinMax[0] <= Gears[le-1][0] and D_MinMax[1] >= Gears[0][0]:
                                                l = 0
                                                NextD = True
            ...
            if Exist[0]:
                ...
                if Check[0]:
                    ...
                    if Check[0]:
                        ...
                        # cdab
                        CurrentCombo = [Ratios[r][2 + n][0], Ratios[r][2 + n][1], Ratios[l][2 + m][0], Ratios[l][2 + m][1]]
                        Check = CheckSet(CurrentCombo)
                        Combos += 1
                        Comparisons += Check[1] + 1
                        if Check[0]:
                            ...
                            # adcb
                            CurrentCombo = [Ratios[l][2 + m][0], Ratios[r][2 + n][1], Ratios[r][2 + n][0], Ratios[l][2 + m][1]]
                            Check = CheckSet(CurrentCombo)
                            Combos += 1
                            Comparisons += Check[1] + 1
                            if Check[0]:
